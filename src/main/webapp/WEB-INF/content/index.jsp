...
<script>
	...
	$(function(){
		...
		$('#table').bootstrapTable({
			url:"http://localhost:8090/SRSDemo/querySectionAll",
			method:'post',
			idField:'sectionSn',
			striped:true,		//隔行变色
...
// 			pageList:[10, 25, 50, 100, 'All'],
			...
			columns: [{
				...
				align: 'center',
				formatter: function(value, row, index){
					return "<button type='button' class='btn btn-primary' onclick=queryEnrolledStudents("+row.sectionNo+")>查看</NOtton>";
				}
			}]
		});
	...
	function selectSection(sectionNo,name){
		...
		swal({
			...
			function(){
				$.ajax({
				      url:'http://localhost:8090/SRSDemo/selectSection',
