			...
			<div class="row">
				<div class="col-md-12">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<a href="/SRSDemo/courseManager">课程管理</a>
						</li>
						<li class="pull-right">
						...
						<form id="courseForm" class="form-horizontal form-row-seperated">
							<div class="form-body">
								...
								<div class="form-group">
									...
									<div class="col-md-9">
										<input id="timeOfDay" name="timeOfDay" type="text" placeholder="请输入时间" class="form-control"/>
									</div>
								</div>
								<div class="form-group">
									<label class="control-label col-md-3">周次：</label>
									<div class="col-md-9">
										<input id="dayOfWeek" name="dayOfWeek" type="text" placeholder="请输入周次" class="form-control"/>
									</div>
								</div>
								<div class="form-group">
									<label class="control-label col-md-3">教室：</label>
									<div class="col-md-9">
										<input id="room" name="room" type="text" placeholder="请输入教室" class="form-control"/>
									</div>
								</div>
								<div class="form-group">
									<label class="control-label col-md-3">容量：</label>
									<div class="col-md-9">
										<input id="capacity" name="capacity" type="text" placeholder="请输入容量" class="form-control"/>
									</div>
								</div>
							</div>
						</form>
...
<script src="js/ui-extended-modals.js"></script>
...
<script>
	...
	$(function(){
		$('#table').bootstrapTable({
			url:"http://localhost:8090/SRSDemo/queryCourse",
			method:'post',
            toolbar:'#btn',
			striped:true,		//隔行变色
...
// 			pageList:[10, 25, 50, 100, 'All'],
			...
			columns: [
		        ...
		        {field:'timeOfDay',title:'时间',width:100,align:'center'},
		        {field:'dayOfWeek',title:'周次',width:100,align:'center'},
		...
		$('#addCourse').bind("click", function(){
    		...
    		var professor_sn=$("#professor_sn").val();
    		if(name==""){
    			swal("系统提示", "名称不可为空")
    		}else if(number==""){
    			swal("系统提示", "编号不可为空")
	...
	function deleteCourse()
	{
		...
		if( row.length == 1 )
		{
			swal({
				...
				{
					$.ajax({
					      url:'http://localhost:8090/SRSDemo/deleteCourse',
